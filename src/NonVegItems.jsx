...
function NonVegItems() {
    ...
    if (category === "below300") {
        filteredItems = nonVegItems.filter(item => item.price < 300);
    ...
    return (
        <Container>
            <h1 className="text-center text-purple my-4">Welcome To NonVegItems.......</h1>
            ...
            <div className="d-flex justify-content-center mb-4">
                <ToggleButtonGroup type="radio" name="priceFilter" value={category}>
                    <ToggleButton 
                        ...
                        id="below300" 
                        value="below300" 
                        onClick={() => handleCategoryChange("below300")}
                    >
                        Below ₹300
                    </ToggleButton>
                    <ToggleButton 
                        ...
                        id="above300" 
                        value="above300" 
                        onClick={() => handleCategoryChange("above300")}
                    >
                         Above ₹300
                    </ToggleButton>
                </ToggleButtonGroup>
