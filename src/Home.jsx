...
const Home = () => {
    ...
    const categories = [
        { name: "Vegetables", image: "Vegetables.jpeg", route: "/vegitems" },
        { name: "Non-Veg", image: "nonveg.jpeg", route: "/nonvegitems" },
        { name: "Milk Products", image: "milk.jpeg", route: "/milkitems" }
    ];
            ...
            <Row className="justify-content-center g-4 mt-4">
                {categories.map(category => (
                    <Col key={category.name} xs={12} md={4}>
                        <Card className="shadow-lg" onClick={() => navigate(category.route)} style={{ cursor: "pointer" }}>
                            <Card.Img 
                                variant="top" 
                                src={category.image} 
                                alt={category.name} 
